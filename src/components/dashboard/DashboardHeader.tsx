      ...
      <div className="flex h-14 sm:h-16 items-center justify-between px-2 sm:px-4 gap-2 sm:gap-4">
        ...
        <div className="flex-1 max-w-md lg:max-w-xl hidden sm:block">
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-9 sm:pl-10 pr-16 sm:pr-20 h-9 sm:h-10 bg-muted/40 border border-border/50 focus:border-primary/50 focus-visible:ring-2 focus-visible:ring-primary/20 rounded-lg sm:rounded-xl text-sm transition-all duration-300"
            />
        ...
        <div className="flex items-center gap-1 sm:gap-1.5">
          ...
          <Button 
            ...
            size="icon"
            onClick={toggleTheme}
            className="h-8 w-8 sm:h-9 sm:w-9 rounded-lg sm:rounded-xl hover:bg-primary/10 hover:text-primary transition-all duration-300"
          >
            {theme === 'dark' ? (
