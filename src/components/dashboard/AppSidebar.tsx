...
export const AppSidebar = ({ 
  ...
  const navigationItems = [
    ...
    { id: 'lpg-stock', title: 'LPG Stock (22mm)', icon: Package, roles: ['owner', 'manager'], badge: analytics.lowStockItems.length > 0 ? analytics.lowStockItems.length : null },
    { id: 'lpg-stock-20mm', title: 'LPG Stock (20mm)', icon: Package, roles: ['owner', 'manager'] },
